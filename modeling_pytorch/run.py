...
from utils import parse_comet_config
...
def argument_parser():
    ...
    parser.add_argument('--config', default='branchy_config', type=str, help='config')
    parser.add_argument('--trainer', default='branchyNet_trainer', type=str,
                        help='trainer')
    parser.add_argument('--dataset', default='cifar10', type=str,
                        help='dataset')
    parser.add_argument('--model', default='branchyNet', type=str, help='model')
